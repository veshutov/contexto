...
export const metadata: Metadata = {
  ...
  title: "Один контекст",
  description: "Сможете ли вы угадать секретное слово, загаданное с помощью искусственного интеллекта? После каждой попытки будет видно, насколько вы близки к ответу.",
